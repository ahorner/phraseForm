...
p. Or you can always create an empty object and attach your form later, like so:
...
p. Need to get the end result of your contextualized query string with the user's input values inserted, to display or log somewhere? There's a utility for that:
